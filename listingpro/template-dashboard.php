				...
				<ul class="sidebar-nav clearfix" id="sidebar">    
						...
						<?php } ?>
							...
							if( $simpleDashboard == false && $dashboard_usr_show == true && $discounts_show == true ):
								?>
								<li><a <?php echo $activeDiscountMenu; ?> href="<?php echo $currentURL.$perma.$dashQuery.'discounts'; ?>"><span class="sub_icon sub_iconfirst"><i class="fa fa-bar-chart" aria-hidden="true"></i></span> <?php echo esc_html__('Discounts/Deals', 'listingpro'); ?> <span class="sub_icon sub_iconsecond simptip-position-right simptip-movable" data-tooltip="<?php echo esc_html__('Discounts/Offers/Deals', 'listingpro'); ?>"><i class="fa fa-bar-chart" aria-hidden="true"></i></span></a> </li>
							<?php endif; ?>
