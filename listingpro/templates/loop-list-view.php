        ...
        <div class="grid-style-container">
            ...
            <div class="lp-listing-bottom">
               ...
               <?php echo $openStatus; ?>
                ...
                <h4><?php echo $CHeckAd; ?> <a href="<?php the_permalink(); ?>"><?php echo $lp_title_grid; ?></a></h4>
            ...
            <div class="lp-listing-bottom">
                <div class="<?php echo $listing_discount_count; ?> clearfix lp-listing-bottom-left-full <?php if( $listing_discount_count == 0 ){echo '';} ?>">
                    ...
                    <div class="lp-bottom-left-full-outer">
                        <h4><?php echo $CHeckAd; ?> <a href="<?php the_permalink(); ?>"><?php echo $lp_title; ?></a></h4>
                            ...
                            <div class="lp-listing-announcements" id="ann-<?php echo get_the_ID(); ?>">
                                <div class="lp-listing-announcement">
                                    <div class="popup-header">
                                        <strong><?php echo esc_html__( 'Announcements' ); ?><span class="close-ann"><i class="fa fa-times" aria-hidden="true"></i></span></strong>
                                    </div>
                                    <?php
                                    $ann_counter    =   1;
                    ...
                    if( is_array( $listing_discount ) && !empty( $listing_discount ) ):
                        ...
                        <div id="coup-<?php echo get_the_ID(); ?>" class="lp-listing-bottom-right <?php echo $coupon_mobile; ?>">
                            <?php if(wp_is_mobile()): ?>
                                <div class="popup-header">
                                    <strong><?php echo esc_html__( 'Coupon Code' ); ?><span class="close-coupon"><i class="fa fa-times" aria-hidden="true"></i></span></strong>
                                </div>
                            <?php endif; ?>
                            <?php
							...
							<div class="dis-code-copy-pop deal-copy-<?php echo get_the_ID(); ?>" id="dicount-copy-<?php echo get_the_ID(); ?>">
                                ...
                                <div class="dis-code-copy-pop-inner">
                                    <div class="dis-code-copy-pop-inner-cell">
                                        ...
                                        <p class="dis-code-copy-wrap"><input class="code-top-copy-<?php echo get_the_ID(); ?>" type="text" value="<?php echo $listing_discount['disCod']; ?>"> <a data-target-code="dicount-copy-<?php echo get_the_ID(); ?>" href="#" class="copy-now">Copy</a></p>
                                    </div>
                                </div>
                            </div>
                        </div>
