                    ...
                    <div class="row">
						...
						?>
                            <ul style="float:left" id="select-lp-more-filter" class="lp-sorting-filter-outer margin-top-10 filter-in-header">
								...
								?>
                                <li><a data-value="listing_rate" class="rated-filter header-filter-wrap"><i class="fa fa-star-o" aria-hidden="true"></i> <?php esc_html_e('Highest Rated','listingpro'); ?></a></li>
								<?php
								}
								...
								?>
                                <li><a data-value="listing_reviewed" class="reviewed-filter header-filter-wrap"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> <?php esc_html_e('Most Reviewed','listingpro'); ?></a></li>
								<?php
								}
								...
								?>
                                <li><a data-value="mostviewed" class="viewed-filter header-filter-wrap"><i class="fa fa-eye" aria-hidden="true"></i> <?php esc_html_e('Most Viewed','listingpro'); ?></a></li>
								<?php
								}								
								?>
                            </ul>
                    ...
                    <div class="listing-simple">
                        ...
                        <div id="content-grids" class="listing-with-header-filters-wrap <?php echo $v2_toggle; ?>">
                            ...
                            <?php
                                ...
                                $array['features'] = '';
                                if( !empty($_GET['s']) && isset($_GET['s']) && $_GET['s']=="home" ){
                                    echo listingpro_get_campaigns_listing( 'lp_top_in_search_page_ads', false,$taxQuery,$TxQuery,$priceQuery,$sKeyword, 2, null);
                                }else{
