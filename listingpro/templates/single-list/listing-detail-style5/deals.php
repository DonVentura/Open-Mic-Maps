                        ...
                        <div class="deal-details">
                            ...
                            <div class="deal-content">
                                ...
                                <div class="lp-dis-code-copy deal-<?php echo $deal_counter; ?>">
                                    <div class="popup-header"><strong><?php echo esc_html__( 'Coupon Code' ); ?></strong><i data-target-code="deal-<?php echo $deal_counter; ?>" class="fa fa-times close-copy-code" aria-hidden="true"></i></div>
