        ...
        <div class="panel with-nav-tabs panel-default lp-dashboard-tabs col-md-12">
            ...
            <div class="panel-body">
                <div class="lp-main-title clearfix">
                    <div class="col-md-2 text-center"><p><?php esc_html_e('deal','listingpro'); ?></p></div>
                    <div class="col-md-2 text-center"><p><?php esc_html_e('Coupon code','listingpro'); ?></p></div>
                    <div class="col-md-2 text-center"><p><?php esc_html_e('discount','listingpro'); ?></p></div>
                    <div class="col-md-2 text-center"><p><?php esc_html_e('start date','listingpro'); ?></p></div>
                    <div class="col-md-2 text-center"><p><?php esc_html_e('end date','listingpro'); ?></p></div>
                        ...
                        if( $d_listings->have_posts() ): while ( $d_listings->have_posts() ): $d_listings->the_post();
                            ...
                            foreach ( $listing_discount_data as $key => $discount_data ):
                                ...
                                <div class="lp-listing-outer-container clearfix lp-coupon-outer-container">
                                    ...
                                    <div class="col-md-2 text-center">
                                        <div class="lp-coupon-code-section lp-content-before-after" data-content="<?php esc_html_e('Coupon Code','listingpro'); ?>">
                                            <?php
                                            ...
                                            <form class="lp-coupons-form-inner">
                                                ...
                                                <div class="lp-coupon-box-row">
                                                    <div class="row">
                                                        ...
                                                        <p class="col-md-12 margin-top-10"><?php echo esc_html__('*Skip this if your deal doesnt include a coupon', 'listingpro'); ?></p>
                                                    </div>
                                                </div>
                                                <div class="lp-coupon-box-row">
                                                    <div class="row">
                                                        ...
                                                        <p class="col-md-12 margin-top-10"><?php echo esc_html__('*If left blank the defualt text "CLICK HERE" will be used. ', 'listingpro'); ?></p>
                    ...
                    <div class="form-group col-sm-6 ">
                        <div class="lp-listing-selecter-drop">
							<div class="lp-pp-noa-tip">
							 	<i class="fa fa-exclamation" aria-hidden="true"></i> <?php echo esc_html__('Discount/Deals not allowed with this listing. Please upgrade your plan.'); ?>
							</div>
                            <select class="form-control select2-ajax" name="dis-listing" id="dis-listing">
