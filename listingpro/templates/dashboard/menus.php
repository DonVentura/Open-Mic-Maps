                                                                            ...
                                                                            <div class="lp-menu-form-inner">
                                                                                <form class="row">
                                                                                    ...
                                                                                    <div class="lp-menu-save-btns clearfix">
                                                                                        <button class="lp-cancle-btn cancel-update-menu"><?php echo esc_html__('cancle', 'listingpro'); ?></button>
                        ...
                        <div class="form-group col-sm-6 ">
                            <div class="lp-listing-selecter-drop">
								<div class="lp-pp-noa-tip">
								    <i class="fa fa-exclamation" aria-hidden="true"></i> <?php echo esc_html__('Menu not allowed with this listing. Please upgrade your plan.'); ?>
								</div>
                                <select name="menu-listing" id="menu-listing" class="form-control select2-ajax">
