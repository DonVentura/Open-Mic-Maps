                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-5">
                                                                <div class="jFiler-input-dragDrop pos-relative">
                                                                    ...
                                                                    <div class="upload-field dashboard-upload-field edit-upload-<?php echo $eID; ?>">
                ...
                <div class="form-group col-sm-6 ">
                    <div class="lp-listing-selecter-drop">                        
					   <div class="lp-pp-noa-tip">
					       <i class="fa fa-exclamation" aria-hidden="true"></i> <?php echo esc_html__('Event not allowed with this listing. Please upgrade your plan.'); ?>
					   </div>
