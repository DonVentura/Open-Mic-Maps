                ...
                <div class="tab-content clearfix">
                    <div class="tab-pane fade in active" id="tab1default">
                        ...
                        foreach( $resultsinArray as $data ){
                            ...
                            $dataAttass = 'data-inoviceno="'.$invoiceno.'" data-date="'.$invdate.'" data-amount="'.$plan_price.'" data-tax="'.$latestTax.'" data-method="'.$pmethod.'" data-plan="'. $plan_title.'" data-duration="'.$pdays.'" data-orprice=" '.$plan_priceORG.' " ';
                            ?>
					...
					<div class="tab-pane fade" id="tab2default">
                        ...
                        foreach( $results3 as $data ){
                            ...
                            $dataAttass = 'data-inoviceno="'.$invoiceno.'" data-date="'.$invdate.'" data-amount="'.$plan_price.'" data-tax="'.$latestTax.'" data-method="'.$pmethod.'" data-plan="'. $plan_title.'" data-duration="'.$pdays.'" ';
                            ?>
                                ...
                                <div class="md-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="lp-invoices-other-details margin-bottom-30">
                                            <ul class="clearfix">
                                                <li><?php echo esc_html__('Subtotal', 'listingpro'); ?> <span class="lppopamount">$28.00</span></li>
